...
import profilePic from '~/src/react/assets/profilePic.webp';
import curriculum from '~/src/react/assets/curriculum.pdf';
...
function Home() {
	...
	return (
		<div className='l-home' id='home'>
			<section>
				<h1>Bem-vindo(a)!</h1>
				<p id='l-description'>Seja bem-vindo(a) ao meu portfólio, aqui vou manter uma coleção de todos os projetos que montei e trabalhei para que você possa explorá-los!</p>
			</section>
